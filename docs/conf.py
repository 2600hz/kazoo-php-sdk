...
htmlhelp_basename = 'kazoo-php-sdkdoc'
...
latex_documents = [
  ('index', 'KazooPHPSDKDoc.tex', u'Kazoo PHP SDK',
   u'2600hz Inc', 'manual'),
]
...
man_pages = [
    ('index', 'kazoo-php-sdk', u'Kazoo PHP SDK Documentation',
     [u'2600hz Inc'], 1)
]
...
latex_documents = [
  ('index', 'kazoo-php-sdk.tex', u'Kazoo PHP SDK Documentation',
   u'2600hz Inc', 'manual'),
]
