...
// echo $client->Account()->Device("f5970725ea5907ffd8dd5a2ae9359b65");

var_dump("List the users for the account used to authenticate");
echo $client->Account()->Users();

// var_dump("List the users for a specific account");
// echo $client->Account()->User("0b9e7613ad0ae3a6393279fec8e28c48");